...
import { SetEvent } from "./user.store"

export const  SetEventFun= (userDetails:any)=>{
    ...
    return async (dispatch:any)=>{
        ...
        console.log("dispatch from seteevnt function",dispatch)
    ...
    //     dispatch(SetEvent(userData.userData))
